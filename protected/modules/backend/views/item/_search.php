<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textFieldRow($model,'cid',array('class'=>'span5','maxlength'=>10)); ?>
		...
		<?php echo $form->textFieldRow($model,'num',array('class'=>'span5','maxlength'=>11)); ?>
		...
		<?php echo $form->textFieldRow($model,'is_showcase',array('class'=>'span5')); ?>
