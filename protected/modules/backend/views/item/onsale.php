    ...
    <form action="<?php echo $this->createUrl('bulk'); ?>" id="item-form" method="POST" enctype="multipart/form-data">
                ...
                <?php foreach ($items as $item) : ?>	
                    <tr class="order_item">           
                        ...
                        <td class="title" style="position:relative">
                            <a href="<?php echo $this->createUrl('/detail/index', array('item_id' => $item->item_id)); ?>" target="_blank"><?php echo $item->title; ?></a>
        ...
        <div class="col-md-6">
            <div class="control-group bulk">
                ...
                <button type="submit" onclick="$('#act').val(this.value)" value="showcase" class="btn btn-primary btn-sm">推荐</button>
                <button type="submit" onclick="$('#act').val(this.value)" value="un_showcase" class="btn btn-primary btn-sm">取消推荐</button>            
            </div>        
        </div>
        <div class="col-md-6">
