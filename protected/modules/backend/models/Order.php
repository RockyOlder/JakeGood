...
class Order extends IActiveRecord {
    ...
    public function rules()
    {
        ...
        return array(
            array('market_id, store_id, status, pay_status, ship_status, refund_status', 'numerical', 'integerOnly' => true),
            array('order_id', 'length', 'max' => 20),
            array('user_id, total_fee, ship_fee, pay_fee, pay_time, ship_time, created, updated', 'length', 'max' => 10),
            ...
            array('order_id, user_id, market_id, store_id, status, pay_status, ship_status, refund_status, '
                . 'total_fee, ship_fee, pay_fee, pay_method, ship_method, receiver_name, receiver_country, '
