...
<header class="site-mast">
    ...
    <div class="site-mast__branding cf">
        <a href="/" style="float:left;width:220px;height:70px;margin-top:25px;"><img src="/themes/mt/img/logo.png" /></a>
        ...
        <div class="site-commitment pngfix">
            ...
            <a class="commitment-item commitment-item--expire" href="#" target="_blank"></a>
        </div>    
    </div>
</header>