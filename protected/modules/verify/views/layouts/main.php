...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="topbar-main">
                        ...
                        <ul class="nav navbar navbar-top-links navbar-right mbn">
                            <li class="dropdown topbar-user">
                                <a href="/verify" id="top-store">
                                    <img src="<?php echo $this->store->logo; ?>"class="img-responsive img-circle" />
        ...
        <!--CORE JAVASCRIPT-->
        <script src="/assets/skin/fourteen/js/main.js"></script>
        ...
        <script src="/assets/skin/fourteen/vendors/jquery-maskedinput/jquery-maskedinput.js"></script>
