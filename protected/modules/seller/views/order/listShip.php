<style type="text/css">
    ...
    .order_list .order_item td.contact{border-bottom: 1px solid #D4E7FF;}
</style>
    ...
    <div class="col-lg-12">
        ...
        <div class="">
            <ul class="nav nav-tabs ul-edit responsive hidden-xs hidden-sm">
                ...
                <li class="<?php if ($this->action->id == 'listShip') echo 'active'; ?>">
                        ...
                        <tr class="order_item">
                            ...
                            <?php if ($itemk == 0) : ?>
                                ...
                                <td rowspan="<?php echo $countItems; ?>">
                                    <a href="<?php echo $this->createUrl('detail', array('sn' => $order->sn)); ?>" target="_blank">
                                        <button type="button" class="btn btn-info btn-square">查看物流</button>
                                    </a>
                                </td>
                            <?php endif; ?>
                        </tr>
