    ...
    <form action="<?php echo $this->createUrl('bulk'); ?>" id="item-form" method="POST" enctype="multipart/form-data">
                ...
                <?php foreach ($items as $item) : ?>	
                    <tr class="order_item">           
                        ...
                        <td class="pic" width="80">
                            <img src="<?php echo $item->pic_url; ?>" height="80" width="80"/>
                        </td>
        ...
        <div class="col-md-6">
            <div class="control-group bulk" style="padding-top:10px">
                <input type="hidden" name="referer" value="stock" />
                <input type="hidden" id="act" name="act" value="un_show" />
                <button type="submit" onclick="$('#act').val(this.value)" value="is_show" class="btn btn-primary btn-sm">上架</button>
                <button type="submit" onclick="$('#act').val(this.value)" value="delete" class="btn btn-primary btn-sm">删除产品</button>      
            </div>
        </div>
        <div class="col-md-6">
