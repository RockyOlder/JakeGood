...
?>" no="1" >
            ...
            <li no="2" class="<?php
                    ...
                    ?>"><a href="<?php echo Yii::app()->createUrl('/m/order', array('filter[orderStatus]' => $fOrderKey[1])); ?>"><?php echo $fOrderStatus[1]; ?></a></li>
            <li no="3" class="<?php
                if ($host == 3) {
                    echo 'cur';
                }
                    ?>"><a href="<?php echo Yii::app()->createUrl('/m/order', array('filter[orderStatus]' => $fOrderKey[3])); ?>"><?php echo $fOrderStatus[3]; ?></a></li>
        </ul>
    </div>
                    ...
                    <?php foreach ($orders as $k => $order) : ?>
                        ...
                        <div class="order">
                            <div class="order_head">
                                <?php
                                if ($order->status == 2) {
                                    echo CHtml::link('确认收货', $this->createUrl('/m/order/confirm', array('sn' => $order->sn)), array('class' => 'btn btn-danger'));
                                    ...
                                    echo CHtml::link('去支付', $this->createUrl('/m/order/pay', array('sn' => $order->sn)), array('class' => 'btn btn-danger'));
                                }
                                ?>
                                ...
                                <a class="btn btn-primary" href="<?php echo $this->createUrl('/m/order/detail', array('sn' => $order->sn)); ?>">查看详情</a>
