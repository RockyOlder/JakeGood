...
<html lang="zh-CN">
    ...
    <body>
        <div id="J_bar1" class="hd_bar fixed in">
            <form id="searchForm" onsubmit="return false;" class="hd_search_frm hd_search_frm_focus" action="###">
                <input type="search" placeholder="搜索京东全部商品" autocomplete="off" id="keyWord" class="hd_search_txt hd_search_txt_null">
                ...
                <div id="sortBlock" class="mod_fixed_wrapper mod_filter_fixed in">  <!-- mod_filter_fixed -->
                    <div class="mod_filter">
                        <div class="mod_filter_inner">
                            <a sort-type="default" class="no_icon select" cg="0-2-1" href="javascript:">默认</a>
                            <a mark="1" sort-type="price" class="" cg="0-2-2" href="javascript:">价格<i cg="0-2-2" class="icon_sort"></i></a>  <!-- filter_desc -->
                            <a sort-type="sale" class="state_switch" cg="0-2-4" href="javascript:">销量<i cg="0-2-4" class="icon_sort_single"></i></a>
                            <a sort-type="comment" class="state_switch" cg="0-2-5" href="javascript:">人气<i cg="0-2-5" class="icon_sort_single"></i></a>
